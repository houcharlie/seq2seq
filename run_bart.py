...
output_dir = '/home/ubuntu/bartone'
max_seq_length = 64
data_num_workers = 51
...
dataset = load_dataset(dataset_name, split="train[:5%]", cache_dir='/home/ubuntu/huggingface')
...
model = BartForConditionalGenerationOne.from_pretrained("facebook/bart-base")
...
for epoch in range(starting_epoch, num_train_epochs):
    ...
    for step, batch in enumerate(train_dataloader):
        ...
        if accelerator.is_main_process:
            if step % 100 == 0:
                print('Epoch', epoch, 'step', step, 'loss', loss.detach().float(), 'percent done', completed_steps/num_update_steps_per_epoch)
